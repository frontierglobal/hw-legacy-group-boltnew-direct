  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="available_units" className="block text-sm font-medium text-gray-700">
              Available Units
            </label>
            <input
              type="number"
            ...
            {errors.available_units && (
              <p className="mt-1 text-sm text-red-600">{errors.available_units.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            />
            {errors.total_units && (
              <p className="mt-1 text-sm text-red-600">{errors.total_units.message}</p>
            )}
          </div>
        </div>
