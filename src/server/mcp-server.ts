...
export class MCPServerManager {
    ...
    async connect(serverName: string): Promise<any> {
        try {
            ...
            this.handleConnectionError(serverName, error instanceof Error ? error : new Error(String(error)));
            throw error;
        }
    }
    ...
    async disconnect(serverName: string): Promise<void> {
        try {
            ...
            logger.error(`Error disconnecting from ${serverName}:`, error instanceof Error ? error : new Error(String(error)));
            throw error;
        }
    }
    ...
    async listTables(serverName: string): Promise<string[]> {
        try {
            ...
            logger.error(`Error listing tables for ${serverName}:`, error instanceof Error ? error : new Error(String(error)));
            throw error;
        }
    }
}
